      ...
      this.primitives = {
          calculateSpeed: new CustomPrimitive({
              ...
              fragmentShaderSource: new Cesium.ShaderSource({
                  sources: [Util.loadText(glslDirectory + 'calculateSpeed.frag')]
              }),
          ...
          updatePosition: new CustomPrimitive({
              ...
              fragmentShaderSource: new Cesium.ShaderSource({
                  sources: [Util.loadText(glslDirectory + 'updatePosition.frag')]
              }),
          ...
          postProcessingPosition: new CustomPrimitive({
              ...
              fragmentShaderSource: new Cesium.ShaderSource({
                  sources: [Util.loadText(glslDirectory + 'postProcessingPosition.frag')]
              }),
